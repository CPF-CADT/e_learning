...
const feedbackList = [
    ...
    {
      image: dummyProfiles[5],
      username: "Ratanak Vuth",
      star: 3,
      date: "2023-Mar-09",
      description: "Good course overall, but some parts felt too fast-paced for beginners."
    },
    {
      ...
      star: 5,
      date: "2023-Mar-27",
      description: "Amazing UI/UX and PowerPoint design course. I’m creating much better presentations now."
    },
    {
      image: dummyProfiles[7],
      username: "Vannak Chea",
      star: 4,
      date: "2023-Feb-14",
      description: "Really enjoyed the lessons and the structure. Looking forward to more from this instructor."
    },
    {
      image: dummyProfiles[8],
      username: "Sokmean Neang",
      star: 5,
      date: "2023-Jan-30",
      description: "The teacher explained everything so clearly. Perfect for new learners!"
    },
    {
      image: dummyProfiles[9],
      username: "Chenda Nguon",
      star: 5,
      date: "2023-Mar-04",
      description: "Excellent English grammar explanations! Helped me a lot with writing emails."
    }
  ];
